...
<nav class="navbar navbar-light bg-light"><div class="navFlex">
    ...
    </a><p class="navbar-brand">!Bienvenido de nuevo <?php if(isset($_SESSION["client"])){
        echo $_SESSION["client"];
    }?>!</p> <a class="nav-link" href="panel.php">Inicio</a> <a class="nav-link" href="statistics.php">Estadisticas</a> </div><a href="<?=BASE_URL?>/clientLog/logOUt"><button class="btn btn-danger">Log Out</button></a>
  </nav>
