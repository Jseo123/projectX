...
<body>
  <nav class="navbar navbar-light bg-light">
    <div class="navFlex">
      ...
      <p class="navbar-brand">!Bienvenido de nuevo <?php if (isset($_SESSION["admin"])) {
                                                      echo $_SESSION["admin"];
                                                    } ?>!</p> <a class="nav-link" href="adminDash">Inicio</a> <a class="nav-link" href="statistics.php">Estadisticas</a>
    </div><a href="<?= BASE_URL ?>/adminLog/logOUt"><button class="btn btn-danger">Log Out</button></a>
  </nav>
